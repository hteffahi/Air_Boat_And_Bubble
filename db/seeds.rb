...
boat_1 = Boat.new(name: "titanic", capacity: 4000, category: "liner", price: 20_000, address: "4 rue de Thorigny, Paris")
boat_1.photo.attach(
...
boat_2 = Boat.new(name: "Tulipe", capacity: 15, category: "Barge", price: 1500, address: " port de la conference, Paris")
boat_2.photo.attach(
...
boat_3 = Boat.new(name: "Unsinkable II", capacity: 20, category: "Barge", price: 300, address: "port de la bourdonnais, Paris")
boat_3.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_4= Boat.new(name: "Atlantis", capacity: 3, category: "Fishing Boat", price: 499, address: "1 port de Bercy Aval, Paris")
boat_4.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_5 = Boat.new(name: "Serendipity", capacity: 12, category: "Yatch", price: 2350, address: "chem de bellevue 3, 1197 Parangins Suisse")
boat_5.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_6 = Boat.new(name: "Aurora", capacity: 15, category: "Yatch", price: 8000, address: "50 quai Rambaud, Lyon")
boat_6.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_7 = Boat.new(name: "Dream Weaver", capacity: 8, category: "Liner", price: 150, address: "5 rue de chalon-sur-saone, Lyon")
boat_7.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_8 = Boat.new(name: "Sail La Vie", capacity: 5, category: "Floating boat", price: 50, address: "Anse Pharo, Marseille")
boat_8.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_9 = Boat.new(name: "Little King", capacity: 3, category: "Fishing boat", price: 10, address: "Promenade Robert-laffont, Marseille")
boat_9.photo.attach(
  io: URI.open('https://www.nauticpulsion.com/wp-content/uploads/2021/05/IMG-20210510-WA0008-e1685103112693-768x577.jpg'),
...
boat_10 = Boat.new(name: "Yatch1387", capacity: 3, category: "Yatch", price: 3, address: "Quai Marcel Pagnol, Marseille")
